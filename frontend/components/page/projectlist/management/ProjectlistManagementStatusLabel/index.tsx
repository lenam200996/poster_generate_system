...
const ProjectlistManagementStatusLabel = (props: Props) => {
  ...
  return (
    <div className='flex items-center'>
      ...
      <p className={`text-sm text-[#5a5a5a] ${statusTextColor(props.status)}`}>
...
export default ProjectlistManagementStatusLabel
