...
interface Props {
  item: Pick<Footer, "id" | "name" | "media" | "plate">
  onChange?: (name: string, value: string | string[] | Footer["plate"]) => void
}

const ImportFooterForm = (props: Props) => {
  ...
  return (
    <table className='w-full text-sm text-content-default-primary'>
      <tbody>
        {["/import/footer/edit/[id]", "/import/footer/detail/[id]"].includes(
          router.pathname,
        ) && (
...
export default ImportFooterForm
