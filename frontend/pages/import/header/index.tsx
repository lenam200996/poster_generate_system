...
import { DocumentHeadLineWithCountDto } from "@/openapi/api"
...
const HeaderPage: NextPage = () => {
  ...
  const [items, setItems] = useState<DocumentHeadLineWithCountDto["data"]>([])
  ...
  const getDocumentFooterList = async () => {
    try {
      ...
      const response =
        await apiClient.documentHeadLinesApi.documentHeadLineControllerList(
          params.take,
          params.skip,
          params.name,
        )
        ...
        <div className='mb-5 mt-4 w-full px-10'>
          <div className='flex items-end justify-between'>
            ...
            <div className='mb-2'>
              <MuiButton
                variant='contained'
                onClick={() => router.push("/import/header/new")}
              >
                新規見出し登録
              </MuiButton>
            </div>
